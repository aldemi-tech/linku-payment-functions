  ...
  async completeTokenization(
    ...
    try {
      ...
      const cardData: PaymentCard = {
        ...
        expiration_month: cardInfo.expiration_month ? Number.parseInt(cardInfo.expiration_month) : null,
        expiration_year: cardInfo.expiration_year ? Number.parseInt(cardInfo.expiration_year) : null,
      ...
      return {
        ...
        card_exp_month: cardInfo.expiration_month ? Number.parseInt(cardInfo.expiration_month) : null,
        card_exp_year: cardInfo.expiration_year ? Number.parseInt(cardInfo.expiration_year) : null,
